...
export const Service = [
  {
    ...
    desc: "We design and build thriving residential communities with modern infrastructure, blending comfort, security, and aesthetics.",
    icon: FaBuilding,
  },
  {
    title: "Property Sales & Marketing",
    desc: "Our expert team connects buyers with premium properties, offering transparent sales processes and professional guidance.",
    icon: SiGooglemarketingplatform,
  },
  {
    title: "Land Acquisition & Documentation",
    desc: "We handle all aspects of secure land acquisition, documentation, and regulatory compliance to ensure a stress-free ownership journey.",
    icon: IoDocumentsSharp,
  },
  {
    title: "Investment Advisory",
    desc: "We provide strategic consulting for real estate investors looking to capitalize on Nigeria’s rapidly evolving property market.",
...
export const projects = [
  {
    estate: "Hilltop Castle Estate Phase 1",
    location: "Epe Lagos",
